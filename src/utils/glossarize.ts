...
export class Application {
  ...
  public start () {
    ...
    this.domRoot.addEventListener("focusin", this.spawnTooltip as any);
  ...
  public destroy () {
    ...
    this.domRoot.removeEventListener("focusin", this.spawnTooltip as any);
    this.domRoot.removeEventListener("focusout", this.spawnTooltip as any);
  }
  ...
  private spawnTooltip = async (e: MouseEvent) => {
    ...
    this.domRoot.appendChild(this.tooltip);
    ...
    if (targetBounding.left + targetBounding.width + 100 > right) {
      ...
      this.tooltip.style.left = targetBounding.left + "px";
    }
