...
const Navbar = () => (
  <nav className="absolute left-0 top-0 h-12 w-full bg-primary">
    <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div className="relative flex items-center justify-between h-12">
        <div className="flex-1 flex items-center justify-left h-full">
          <div className="flex-shrink-0 flex items-center h-full">
            <Link rel="nav" className="block h-full" href={getURI("/")}>
              <Logo colors={["#000", "#000"]} />
            </Link>
          </div>
          <div className="hidden sm:block sm:ml-6">
            <div className="flex space-x-4">
              <Link
                rel="nav"
                className="text-background hover:bg-gray-700 hover:text-white px-3 py-3.5 text-sm font-medium"
                href={getURI("/technos")}
              >
                Technos
              </Link>
    ...
    <div className="sm:hidden bg-primary" id="mobile-menu">
      <div className="px-2 pt-2 pb-3 space-y-1">
        <Link
          rel="nav"
          className="text-background px-3 py-2 text-sm font-medium"
          href={getURI("/technos")}
        >
          Technos
        </Link>
